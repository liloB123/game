...
END_FONT_SIZE = int(0.1 * WINDOW_WIDTH)
END_COLOR = (0,0,0)
END_MESSAGE_LOCATION = \
    (0.2 * WINDOW_WIDTH, WINDOW_HEIGHT / 2 - (END_FONT_SIZE / 2))

LOSE_MESSAGE = "Sorry, you lost"
WIN_MESSAGE = "Good job, you won!"